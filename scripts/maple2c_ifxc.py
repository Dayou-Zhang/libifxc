...
The retained Libxc-derived backend still computes the ML25 values, but the
checked-in generated C/header pair and the generate target keep the milestone
workflow aligned with PLAN.md while the Maple source of truth is being
reintroduced.
"""
...
def emit_header() -> str:
    return """/* Generated by scripts/maple2c_ifxc.py from maple/ifxc_mgga_xc_ml25_features.mpl. Do not edit by hand. */
