...
#if defined(XC_DONT_COMPILE_EXC) || ifxc_maple2c_order < 0 || defined(XC_NO_EXC)
...
#if defined(XC_DONT_COMPILE_VXC) || ifxc_maple2c_order < 1
...
#if defined(XC_DONT_COMPILE_FXC) || ifxc_maple2c_order < 2
...
#if defined(XC_DONT_COMPILE_KXC) || ifxc_maple2c_order < 3
...
#if defined(XC_DONT_COMPILE_LXC) || ifxc_maple2c_order < 4
...
static ifxc_mgga_funcs_variants work_mgga =
  {
