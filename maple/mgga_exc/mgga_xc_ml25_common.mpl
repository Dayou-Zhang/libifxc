(*
 Shared ML25 helper algebra used by both the LAK exchange and LAK correlation
 terms. Keep the common thresholds and transforms here so the top-level ML25
